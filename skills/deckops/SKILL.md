...
The instructions are tested with DeckOps 2.4.0. If `deckops` is missing and Node.js 22.18+
and network access are available, use this command prefix in the examples below:

```bash
npx -y @deckflow/deckops@2.4.0
```
