...
the file itself. In 2.4.0, a cached artifact view can also bypass materialization of a new
...
2.4.0. If the task needs downstream chunks, derive them from the artifact and retain this
minimum evidence:
