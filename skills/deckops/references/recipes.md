...
word with `npx -y @deckflow/deckops@2.3.0`.
...
one-shot portable conversion to create those separate files in 2.3.0.
...
DeckOps 2.3.0 has no JSONL batch mode. Iterate an explicit file list in the host environment,
