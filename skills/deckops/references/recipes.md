...
word with `npx -y @deckflow/deckops@2.4.1`.
...
one-shot portable conversion to create those separate files in 2.4.1.
...
DeckOps 2.4.1 has no JSONL batch mode. Iterate an explicit file list in the host environment,
